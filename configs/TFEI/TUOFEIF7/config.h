...
#define BOARD_NAME                          TUOFEIF7
#define MANUFACTURER_ID                     TFEI
...
// Motors on TIM8 (PC8/PC9) and TIM4 (PB6/PB7); beeper on TIM3_CH3 so that
// TIM8 stays available as a bitbanged DShot pacer (TIM1 is used by camera control).
