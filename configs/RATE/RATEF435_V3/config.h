...
// AT32: dmaopt indexes the DMA channel table (0..6 = DMA1_CH1..7, 7..13 = DMA2_CH1..7);
// every DShot output needs its own channel.
#define TIMER_PIN_MAPPING \
    TIMER_PIN_MAP( 0, PA3,  2, -1 ) \
    TIMER_PIN_MAP( 1, PC9,  2,  0 ) \
    TIMER_PIN_MAP( 2, PA8,  1,  1 ) \
    TIMER_PIN_MAP( 3, PA9,  1,  2 ) \
    TIMER_PIN_MAP( 4, PA10, 1,  3 ) \
    TIMER_PIN_MAP( 5, PB1,  2,  4 )
